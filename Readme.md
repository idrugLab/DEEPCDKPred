...
### 2. Model
The best trained models are in ***model_save/***

### 3. Prediction with trained models
For example, to predict new molecules (in *test.csv*) with trained CDK9 model, use the command:

`python predict.py  --predict_path test.csv  --model_path model_save/hyper-cdk9/model.pt  --result_path result_CDK9.csv`

The result file only contains the prediction of CDK9. 
